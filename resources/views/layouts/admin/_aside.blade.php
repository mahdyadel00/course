<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @endcan
            @can('marketings_index')
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.marketings.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Marketing Fields</span>
                    </a>
                </li>
            @endcan
            @can('roles_index')
            ...
            @can('speakers_index')
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('admin.speakers.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Speakers</span>
                    </a>
                </li>
            @endcan
            @can('companyspeakers_index')
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('admin.companyspeakers.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Company Speakers</span>
                    </a>
                </li>
            @endcan
            @can('topicSpeakers_index')
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('admin.topicSpeakers.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Topic Speakers</span>
                    </a>
                </li>
            @endcan
            @can('orders_index')
            ...
            @endcan
            @can(['settings_edit', 'settings_update'])
                <li class="nav-item">
            ...
            @can('polices_index')
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('admin.polices.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Polices</span>
                    </a>
                </li>
            @endcan
            @can('sliders_index')
            ...
            @can('gifits_index')
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('admin.gifits.index') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <span class="nav-link-text ms-1">Gifit</span>
                    </a>
                </li>
            @endcan
            @can('pricing_index')
            ...
            @can('sponsers_index')
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('admin.sponsers.index') }}">
                        ...
                        <span class="nav-link-text ms-1">Sponser</span>
                    </a>
                </li>
            @endcan
