                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-5 ms-auto text-center mt-5 mt-lg-0">
                                    <div class="bg-gradient-primary border-radius-lg h-100">
                                        <img src="{{ asset('dashboard') }}/assets/img/shapes/waves-white.svg"
                                            class="position-absolute h-100 w-50 top-0 d-lg-block d-none" alt="waves">
                                        <div
                                            class="position-relative d-flex align-items-center justify-content-center h-100">
                                            <img class="w-100 position-relative z-index-2 pt-4"
                                                src="{{ asset('dashboard') }}/assets/img/illustrations/rocket-white.png"
                                                alt="rocket">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('dashboard') }}/assets/img/small-logos/logo-xd.svg"
                                            ...
                                            <td>
                                                <div class="avatar-group mt-2">
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        ...
                                                        title="Ryan Tompson">
                                                        <img src="{{ asset('dashboard') }}/assets/img/team-1.jpg"
                                                            alt="team1">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                    ...
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        ...
                                                        <img src="{{ asset('dashboard') }}/assets/img/team-3.jpg"
                                                            alt="team3">
                                                    </a>
                                                    <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                                        title="Jessica Doe">
                                                        <img src="{{ asset('dashboard') }}/assets/img/team-4.jpg"
                                                            alt="team4">
                                                    </a>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('dashboard') }}/assets/img/small-logos/logo-atlassian.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('dashboard') }}/assets/img/small-logos/logo-slack.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('dashboard') }}/assets/img/small-logos/logo-spotify.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('dashboard') }}/assets/img/small-logos/logo-jira.svg"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('dashboard') }}/assets/img/small-logos/logo-invision.svg"
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                made with <i class="fa fa-heart"></i> by<p class="font-weight-bold">Geexar</p>
                                for a better web.
                            </div>
                        </div>
                        {{-- <div class="col-lg-6">
